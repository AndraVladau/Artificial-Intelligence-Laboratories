...
def trainedModelSGDRegression(inputs1, inputs2, outputs):
...
def trainedModelBGDRegression(inputs1, inputs2, outputs):
    x = np.column_stack((inputs1, inputs2))
    # print(x)
    # model initialisation
...
def main():
    ...
    w0, w1, w2, regressor = trainedModelSGDRegression(trainInputsGDP, trainInputsFreedom, trainOutputs)
    ...
    # Create the linear regressor
    w0, w1, w2, regressor = trainedModelBGDRegression(trainInputsGDP, trainInputsFreedom, trainOutputs)
